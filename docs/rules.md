...
| [Generic Key](#ghost.generic.3) | ghost.generic.3 | Generic key variable declaration. | generic, key | 1.5 |
| [Generic Password](#ghost.generic.4) | ghost.generic.4 | Generic password variable declaration. | generic, password | 1.5 |
| [Sensitive JWT](#ghost.generic.5) | ghost.generic.5 | Sensitive JWT variable declaration. | generic, jwt | 5.1 |
...
**Description:** Generic key variable declaration.
