...
| [Cohere API Key](#ghost.cohere.1) | ghost.cohere.1 | Matches a Cohere API key variable declaration. | api, cohere | 4.1 |
| [Cohere API Key](#ghost.cohere.2) | ghost.cohere.2 | Matches a Cohere API key variable declaration. | api, cohere | 4.1 |
...
**Description:** Matches a Cohere API key variable declaration.
